...
/* harmony default export */ var execute = (async function (scriptName) {
    const bash = await Object(io.which)('bash', true);
    const prelude = Object(core.getInput)('prelude') || '';
    const mainScript = Object(core.getInput)(scriptName);
    if (!mainScript) {
        return;
    }
    const script = `
    ...
    ${mainScript}
  `;
    Object(external_child_process_.execSync)(script, { shell: bash, stdio: 'inherit' });
});
